<?php
  ...
  class MovieDAO implements MovieDAOInterface {
    ...
    public function create(Movie $movie){
      ...
      // filme adicionado
      $this->message->setMessage("Filme adicoinado com sucesso!", "success", "index.php");
    ...
    public function destroy($id){
      ...
      $this->message->setMessage("Filme removido com sucess!", "sucess", "dashboard.php");
