...
?>
    <div id="main-container" class="container-fluid">
        ...
        <!-- Apenas os filmes que o usuário gostou -->
        <div class="col-md-12" id="movies-dashboard">
            <div class="col-md-12" id="add-movie-container"></div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="actions-column">
                            <a href="<?= $BASE_URL ?>editmovie.php?id=<?= $movie->id ?>" class="edit-btn"> <i class="far fa-edit"></i>Editar
                            </a>
